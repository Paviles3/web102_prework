...
const displayStr = `A total of $${totalRaised.toLocaleString()} has been raised for ${numGames} game${numGames !== 1 ? 's' : ''}. Currently, ${numUnfunded} game${numUnfunded !== 1 ? 's' : ''} ${numUnfunded === 1 ? 'remains' : 'remain'} unfunded. We need your help to fund these amazing games!`;
